...
/**
 * Parse the HOLYSHIP_GATE_ALLOWLIST env var value into hostname and CIDR entries.
 */
 ...
 * @param allowlistEnv - Optional comma-separated allowlist (pass process.env.HOLYSHIP_GATE_ALLOWLIST)
