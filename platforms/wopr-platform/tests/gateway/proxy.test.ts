...
import { createGatewayRoutes } from "@wopr-network/platform-core/gateway/routes";
import type { GatewayAuthEnv } from "@wopr-network/platform-core/gateway/service-key-auth";
import type { FetchFn, GatewayConfig, GatewayTenant } from "@wopr-network/platform-core/gateway/types";
