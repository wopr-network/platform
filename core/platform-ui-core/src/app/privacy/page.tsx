      ...
      <div className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
          <section id="section-1" className="scroll-mt-16">
            ...
            <p>
              {brand.companyLegalName} (&ldquo;{brand.brandName},&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or
              &ldquo;our&rdquo;) is the data controller responsible for your personal data. We operate the{" "}
          ...
          <section id="section-2" className="scroll-mt-16">
            ...
            <p>
              You provide your own API keys for third-party AI providers (the &ldquo;bring your own key&rdquo; model).
          ...
          <section id="section-3" className="scroll-mt-16">
            ...
            <ul className="ml-4 mt-2 list-disc space-y-1">
              <li>
                <span className="text-foreground">Stripe</span> &mdash; payment processing. Stripe receives your billing
                information to process subscription payments. Stripe&apos;s privacy policy governs their handling of
                your payment data.
              </li>
              <li>
                <span className="text-foreground">AI providers</span> (user-selected, bring-your-own-key model) &mdash;
              ...
              <li>
                <span className="text-foreground">Hosting provider</span> &mdash; infrastructure. Our servers and Docker
                fleet are hosted by third-party infrastructure providers who may process data on our behalf under strict
                data processing agreements.
              </li>
              <li>
                <span className="text-foreground">Email service</span> &mdash; transactional emails. We use a
          ...
          <section id="section-4" className="scroll-mt-16">
            ...
            <ul className="ml-4 mt-2 list-disc space-y-1">
              ...
              <li>Right to rectification (Art. 16) &mdash; correct inaccurate or incomplete data</li>
              <li>
                Right to erasure (Art. 17) &mdash; request deletion of your personal data (&ldquo;right to be
                forgotten&rdquo;)
              </li>
              <li>
                Right to restrict processing (Art. 18) &mdash; limit how we use your data in certain circumstances
              </li>
              <li>
                Right to data portability (Art. 20) &mdash; receive your data in a structured, commonly used,
                machine-readable format
              </li>
              <li>Right to object (Art. 21) &mdash; object to processing based on legitimate interest</li>
