...
export function FlowActionBar({ changeCount, onDiscard, onApply, applying, appliedPr }: FlowActionBarProps) {
  if (appliedPr) {
    return (
      <div className="flex items-center justify-between rounded-lg border border-green-500/20 bg-green-500/5 px-4 py-3">
        <span className="text-sm text-green-400">PR #{appliedPr.number} created</span>
        <a
          href={appliedPr.url}
          target="_blank"
