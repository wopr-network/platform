...
export default function ConnectCallbackPage() {
    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-near-black">
        <div className="text-center max-w-md px-6">
          <h1 className="text-2xl font-bold text-off-white mb-4">Waiting for approval</h1>
          <p className="text-off-white/70">
            Your organization admin needs to approve the Holy Ship installation. We'll be ready when they are.
          </p>
        </div>
      </main>
    );
  ...
  if (status === "error") {
    return (
      <main className="min-h-screen flex items-center justify-center bg-near-black">
        <div className="text-center max-w-md px-6">
          <h1 className="text-2xl font-bold text-off-white mb-4">Something went wrong</h1>
          <p className="text-off-white/70 mb-8">GitHub authorization failed. Let's try again.</p>
          <a
            href="/connect"
