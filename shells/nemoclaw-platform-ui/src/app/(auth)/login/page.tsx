    ...
    <div className="grid min-h-dvh lg:grid-cols-2" style={{ background: "#09090b" }}>
      ...
      >
        ...
        <p className="mt-3 text-zinc-400" style={{ fontSize: "15px", lineHeight: 1.6 }}>
          Deploy AI agents from a hot pool of pre-warmed NeMo containers. Chat, iterate, and ship — no infrastructure.
        </p>
        <div className="mt-8 flex flex-col gap-3.5">
          {[
            "Instant deploy from hot container pool",
            "Tab-based chat with persistent history",
            "Metered billing — pay only for inference",
          ].map((perk) => (
        ...
        <div className="mt-6 flex items-center gap-2">
          ...
          >
            <div className="w-2.5 h-2.5 bg-[#76b900] rotate-45 rounded-sm" />
