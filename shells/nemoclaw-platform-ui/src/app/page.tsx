		...
		<div className="min-h-screen bg-[#09090b] text-[#f1f5f9]">
			...
			<section className="bg-gradient-to-b from-[#0a0f1a] to-[#09090b] px-6 py-24 text-center">
				<div className="max-w-3xl mx-auto">
					<p className="text-xs font-semibold tracking-widest uppercase text-[#818cf8] mb-4">
						AI Agent Platform
					</p>
					...
					<p className="text-lg text-[#94a3b8] mb-10 max-w-xl mx-auto leading-relaxed">
						Deploy NVIDIA NeMo agents instantly from a hot pool of pre-warmed
						containers. Chat, iterate, and ship — no infrastructure headaches.
					</p>
				...
				<div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
					<div className="bg-[#0f172a] border border-[#1e293b] rounded-xl p-6">
						...
						<p className="text-sm text-[#94a3b8] leading-relaxed">
							Hot pool of pre-warmed containers. Name it, claim it, chat with
							it. No cold starts.
						</p>
					</div>
					...
					<div className="bg-[#0f172a] border border-[#1e293b] rounded-xl p-6">
						...
						<p className="text-sm text-[#94a3b8] leading-relaxed">
							Tab-based chat. Each agent has its own persistent conversation
							history.
						</p>
					</div>
					...
					<div className="bg-[#0f172a] border border-[#1e293b] rounded-xl p-6">
						...
						<p className="text-sm text-[#94a3b8] leading-relaxed">
							$5 free credits on signup. Metered inference billing. No
