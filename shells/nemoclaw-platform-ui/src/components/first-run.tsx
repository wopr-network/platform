...
export function FirstRun({ onClaim, claiming }: { onClaim: (name: string) => void; claiming: boolean }) {
  ...
  if (claiming) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4">
        ...
        <p className="font-mono text-sm text-muted-foreground/60">Creating your agent...</p>
      </div>
    );
  }
