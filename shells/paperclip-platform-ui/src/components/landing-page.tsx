...
export function PaperclipLanding() {
	...
	return (
		<div className="min-h-dvh text-white" style={{ background: "#09090b" }}>
				...
				>
					<h1
						...
						style={{
							...
							lineHeight: 1.05,
							background:
								"linear-gradient(135deg, #fafafa 0%, #818cf8 50%, #a78bfa 100%)",
					...
					<p
						...
						style={{ color: "#a1a1aa", fontSize: "18px" }}
					>
						AI agents that run your business. Deploy in seconds. They work while
						you sleep.
					</p>
			...
			<section
				id="stories"
				className="relative z-10 mx-auto max-w-xl space-y-20 px-6 py-24"
			>
				{stories.map((story, i) => (
					<motion.div
						key={story.title}
					...
					>
						...
						<p
							...
							style={{ color: "#71717a", fontSize: "18px", lineHeight: 1.7 }}
						>
							{story.body}
						</p>
					</motion.div>
			...
			<section
				id="pricing"
				className="relative z-10 mx-auto max-w-xl px-6 py-24"
			>
				<div className="text-center mb-12">
					...
					<p
						...
						style={{ color: "#71717a", fontSize: "18px", lineHeight: 1.7 }}
					>
						No tiers. No subscriptions. No surprises. Your agents consume
						credits when they work — that&apos;s it.
					</p>
				</div>
				...
				>
					...
					<p className="mt-3" style={{ color: "#71717a", fontSize: "15px" }}>
						Then add credits whenever you need them. Your agents only use
						credits when they&apos;re actually running.
					</p>
