...
const strengthColors = ["bg-red-500", "bg-red-500", "bg-indigo-400", "bg-indigo-500", "bg-emerald-500"];
...
function AuthForm() {
  ...
  async function handleSignIn(e: FormEvent) {
    ...
    try {
      ...
      window.location.href = raw ? sanitizeRedirectUrl(raw) : "/dashboard";
    } catch {
      ...
      <div className="flex min-h-dvh items-center justify-center px-4" style={{ background: "#09090b" }}>
        ...
        >
          ...
          <p className="mt-4 text-sm text-zinc-500">
            ...
            <span className="font-medium text-indigo-400">$5 signup credit</span>.
          </p>
          <div className="mt-6">
  ...
  return (
    <div className="grid min-h-dvh lg:grid-cols-2" style={{ background: "#09090b" }}>
      {/* Left panel — pitch */}
      <div
      ...
      >
        ...
        <p className="mt-3 text-zinc-400" style={{ fontSize: "15px", lineHeight: 1.6 }}>
          Paperclip agents run your business while you sleep. No hiring. No managing. Just results.
        </p>
        <div className="mt-8 flex flex-col gap-3.5">
          {["Agents that code, ship, and iterate", "Your data, your infrastructure", "Pay only for what they use"].map(
            (perk) => (
              <div key={perk} className="flex items-center gap-3 text-sm text-zinc-200">
                <div
      ...
      <div className="flex flex-col justify-center px-6 py-12 sm:px-12 xl:px-16">
        ...
        <div className="mb-8 text-center lg:hidden">
          ...
          <h2 className="text-lg font-bold" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>
            Paperclip
          </h2>
        </div>
        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          >
            <button
              ...
              className={`flex-1 rounded-lg py-2.5 text-sm font-semibold transition-all ${
                tab === "signin" ? "text-white shadow-lg" : "text-zinc-500 hover:text-zinc-300"
              }`}
              style={
                tab === "signin"
                  ? {
            ...
            <button
              ...
              className={`flex-1 rounded-lg py-2.5 text-sm font-semibold transition-all ${
                tab === "signup" ? "text-white shadow-lg" : "text-zinc-500 hover:text-zinc-300"
              }`}
              style={
                tab === "signup"
                  ? {
            ...
            <form onSubmit={handleSignIn} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-indigo-400 no-underline hover:text-indigo-300">
                    Forgot password?
                  </Link>
                </div>
                <Input
              ...
              {error && (
                <div className="flex flex-col gap-2">
                  ...
                  {errorType === "unverified" && (
                    <ResendVerificationButton email={email} variant="outline" className="w-full" />
                  )}
                  {errorType === "suspended" && (
            ...
            <form onSubmit={handleSignUp} className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-2.5 text-sm mt-1">
                <Checkbox
                  ...
                  className="mt-0.5"
                />
                <Label htmlFor="agree-terms" className="font-normal text-zinc-500 cursor-pointer leading-relaxed">
                  I agree to the{" "}
                  <Link href="/terms" className="text-indigo-400 no-underline hover:underline">
                    Terms
                  </Link>{" "}
                  and{" "}
          ...
          <OAuthButtons
            callbackUrl={
              searchParams.get("callbackUrl") ? sanitizeRedirectUrl(searchParams.get("callbackUrl")) : "/dashboard"
            }
          />
        </div>
      </div>
