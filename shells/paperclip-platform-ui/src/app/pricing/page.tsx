            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-800 bg-zinc-900/50">
                  <th className="px-4 py-3 text-left font-medium text-zinc-400">Usage</th>
              ...
              <tbody>
                <tr className="border-b border-zinc-800/50">
                  ...
                  <td className="px-4 py-3 text-right font-mono text-zinc-400">$0.80 / 1M tokens</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 text-zinc-300">Output tokens</td>
                  <td className="px-4 py-3 text-right font-mono text-zinc-400">$4.68 / 1M tokens</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-xs text-zinc-500">Rates pulled from your dashboard. See billing for exact costs.</p>
        </div>
