...
const manifest: PluginManifest = {
	...
	license: "MIT",
	repository:
		"https://github.com/wopr-network/wopr-plugin-superpower-secretary",
	capabilities: [],
	category: "superpower",
	icon: "\uD83D\uDCBC",
	tags: [
	...
	setup: [
		{
			...
			description:
				"She never calls in sick. Connect your email and calendar to get started.",
		},
		{
			id: "gmail",
			title: "Connect Gmail",
			description:
				"Grant access so your secretary can read, draft, and send emails on your behalf.",
			fields: {
				title: "Gmail OAuth",
