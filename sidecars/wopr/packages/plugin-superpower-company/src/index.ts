	...
	setup: [
		{
			...
			description:
				"Each channel becomes a department. Each department gets a dedicated employee.",
		},
		{
			id: "discord",
			title: "Connect Discord",
			description:
				"Add your Discord bot token so employees can work in your server.",
			fields: {
				title: "Discord Bot",
...
const plugin: WOPRPlugin = {
	...
	version: "1.0.0",
	description:
		"Run a Company from Discord -- dedicated employee bots per channel",
	manifest,
