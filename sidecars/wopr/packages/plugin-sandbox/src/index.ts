...
const plugin: WOPRPlugin = {
	...
	version: "1.0.0",
	description:
		"Docker-based session isolation — container lifecycle, per-session context, tool policy engine",
	...
	async init(pluginCtx: WOPRPluginContext) {
		...
		ctx.registerExtension("sandbox", {
			resolveSandboxContext: (await import("./context.js"))
				.resolveSandboxContext,
			getSandboxWorkspaceInfo: (await import("./context.js"))
				.getSandboxWorkspaceInfo,
			...
			filterToolsByPolicy: (await import("./tool-policy.js"))
				.filterToolsByPolicy,
