...
import { type AuthContext, type WebMCPRegistry, type WebMCPTool, registerSlackTools } from "../src/webmcp-slack.js";
...
describe("registerSlackTools", () => {
  ...
  describe("getSlackStatus", () => {
    it("should GET /plugins/wopr-plugin-slack/health", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("/api/plugins/wopr-plugin-slack/health", expect.any(Object));
  ...
  describe("listSlackChannels", () => {
    it("should GET /plugins/wopr-plugin-slack/channels", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("/api/plugins/wopr-plugin-slack/channels", expect.any(Object));
  ...
  describe("getSlackMessageStats", () => {
    it("should GET /plugins/wopr-plugin-slack/stats", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith("/api/plugins/wopr-plugin-slack/stats", expect.any(Object));
