...
export const pluginConfigSchema: ConfigSchema = {
	...
	description:
		"Configure semantic memory with embeddings for auto-recall and auto-capture",
	fields: [
		{
			name: "provider",
			type: "text",
			...
			description:
				"Which embedding provider to use (auto tries OpenAI → Gemini → Ollama → local)",
			default: "auto",
		},
		{
			name: "model",
		...
		},
		{
			...
			description:
				"Maximum byte size for memory_write content (default: 1048576 = 1 MB)",
			default: 1048576,
		},
		{
