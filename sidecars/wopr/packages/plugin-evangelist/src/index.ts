...
const configSchema: ConfigSchema = {
	...
	description:
		"Configure the Evangelist superpower — your product markets itself",
	fields: [
		{
...
const plugin: WOPRPlugin = {
	...
	version: "0.1.0",
	description:
		"Market Your Product superpower — your product markets itself while you sleep",
	manifest: {
		name: "wopr-plugin-evangelist",
		version: "0.1.0",
		description:
			...
			capabilities: [
				{
					type: "superpower",
					id: "evangelist",
					displayName: "Market Your Product",
				},
			],
		},
	...
	async init(context: WOPRPluginContext) {
		...
		ctx.registerSetupContextProvider(({ partialConfig }) => {
			...
			let instructions =
				"You are helping the user set up the Evangelist superpower for WOPR.\n\n";
		...
		if (config?.productOneLiner) {
			...
			logger.warn(
				"No product configured — brand voice not registered. Run setup.",
			);
		}
