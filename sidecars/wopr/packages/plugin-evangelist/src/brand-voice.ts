...
export function createBrandVoiceProvider(
	product: ProductInfo,
): ContextProvider {
	return {
		...
		async getContext(
			...
			const voiceDirections: Record<string, string> = {
				punchy:
					"Be direct, concise, and sharp. Short sentences. No fluff. Every word earns its place.",
				casual:
					"Be friendly, approachable, and conversational. Like talking to a smart friend over coffee.",
				technical:
					"Be precise, detailed, and authoritative. Use correct terminology. Cite specifics.",
			};
