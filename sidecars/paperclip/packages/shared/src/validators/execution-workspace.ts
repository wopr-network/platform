...
export const executionWorkspaceConfigSchema = z
  .object({
...
export const executionWorkspaceCloseReadinessStateSchema = z.enum(["ready", "ready_with_warnings", "blocked"]);
...
export const executionWorkspaceCloseActionSchema = z
  .object({
...
export const executionWorkspaceCloseLinkedIssueSchema = z
  .object({
    id: z.string().uuid(),
...
export const executionWorkspaceCloseGitReadinessSchema = z
  .object({
...
export const workspaceRuntimeServiceSchema = z
  .object({
    id: z.string(),
...
export const executionWorkspaceCloseReadinessSchema = z
  .object({
